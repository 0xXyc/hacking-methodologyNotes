...
Grab the same base64 encoded reverse shell command that we had before to get our reverse shell:
...
Now, create a new file called rev.bat and echo the base64 encoded string to it:

{% code overflow="wrap" %}
```
touch rev.bat

echo  >> rev.bat
```
{% endcode %}
